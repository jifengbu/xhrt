...
public class BroadcastPresenter implements BroadcastContract.Presenter {
    ...
    public void initBroadcast() {
        VhallSDK.getInstance().initBroadcast(param.videoId, param.accessToken, getBroadcast(), new VhallSDK.InitBroadcastCallback() {
            @Override
    ...
    public void finishBroadcast() {
        VhallSDK.getInstance().finishBroadcast(param.videoId, param.accessToken, getBroadcast(), new VhallSDK.FinishBroadcastCallback() {
            @Override
