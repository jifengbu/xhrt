...
module.exports = React.createClass({
    ...
    getListSuccess (data) {
        ...
        if (data.success) {
            ...
            const infiniteLoadStatus = (!list.length && this.pageNo === 1) ? STATUS_NO_DATA : (!list.length && this.pageNo === 1) ? STATUS_NO_DATA : list.length < CONSTANTS.PER_PAGE_COUNT ? STATUS_ALL_LOADED : STATUS_TEXT_HIDE;
