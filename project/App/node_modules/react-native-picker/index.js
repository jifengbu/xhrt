				...
				<View style={[styles.pickerBox, this.state.style]}>
						{
							...
							<View style={[styles.pickerToolbar, this.state.pickerToolBarStyle, {width: this.state.style.width || width}]}>
								<TouchableOpacity activeOpacity={0.6} style={styles.pickerCancelBtn} onPress={this._pickerCancel.bind(this)}>
									<Text style={[styles.pickerFinishBtnText, this.state.pickerBtnStyle,{color: '#A60245'}]}>
								...
								<TouchableOpacity activeOpacity={0.6} style={styles.pickerFinishBtn} onPress={this._pickerFinish.bind(this)}>
									<Text style={[styles.pickerFinishBtnText, this.state.pickerBtnStyle,{color: '#FFFFFF'}]}>
										{this.state.pickerBtnText}
									</Text>
								</TouchableOpacity>
							</View>
