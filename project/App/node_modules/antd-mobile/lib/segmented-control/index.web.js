...
var SegmentedControl = function (_React$Component) {
    ...
    SegmentedControl.prototype.render = function render() {
        ...
        var wrapCls = (0, _classnames2["default"])((_classNames = {}, (0, _defineProperty3["default"])(_classNames, className, !!className), (0, _defineProperty3["default"])(_classNames, '' + prefixCls, true), (0, _defineProperty3["default"])(_classNames, className, className), _classNames));
        var selectedIndex = this.state.selectedIndex;
        var items = values.map(function (value, idx) {
            var _classNames2;

            var itemCls = (0, _classnames2["default"])((_classNames2 = {}, (0, _defineProperty3["default"])(_classNames2, prefixCls + '-item', true), (0, _defineProperty3["default"])(_classNames2, prefixCls + '-item-selected', idx === selectedIndex), _classNames2));
            return React.createElement(
                'div',
                { className: itemCls, key: idx, onClick: function onClick(e) {
