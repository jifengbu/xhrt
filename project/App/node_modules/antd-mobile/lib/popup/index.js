...
var Popup = function (_React$Component) {
    ...
    Popup.prototype.render = function render() {
        return React.createElement(
            _Modal2["default"],
            { animateAppear: true, onAnimationEnd: this.onAnimationEnd, entry: this.props.animationType === 'slide-up' ? 'bottom' : 'top', wrapStyle: this.props.animationType === 'slide-up' ? _index2["default"].wrap : _index2["default"].wrapTop, visible: this.state.visible, onClose: this.props.maskClosable ? this.hide : undefined },
            this.props.children
        );
    };
...
exports["default"] = {
    show: function show(content, options) {
        _rnTopview2["default"].set(React.createElement(
            Popup,
            { animationType: options.animationType, visible: true },
            content
        ));
    },
    hide: function hide() {
