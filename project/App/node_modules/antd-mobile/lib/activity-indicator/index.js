...
var RNActivityIndicator = function (_React$Component) {
    ...
    RNActivityIndicator.prototype._renderToast = function _renderToast() {
        return React.createElement(
            ...
            React.createElement(
                _reactNative.View,
                { style: [_style2["default"].innerContainer, { height: 89 }] },
                React.createElement(
                    _reactNative.View,
                    { style: [_style2["default"].wrapper] },
                    React.createElement(_reactNative.ActivityIndicator, { color: 'white', size: 'large' }),
                    this.props.text && React.createElement(
                        _reactNative.Text,
                        { style: [_style2["default"].toast] },
                        this.props.text
                    )
                )
            )
    ...
    RNActivityIndicator.prototype._renderSpinner = function _renderSpinner() {
        return React.createElement(
            ...
            React.createElement(_reactNative.ActivityIndicator, { color: this.props.color, size: this.props.size }),
            this.props.text && React.createElement(
                _reactNative.Text,
                { style: [_style2["default"].tip] },
                this.props.text
            )
        );
    };
