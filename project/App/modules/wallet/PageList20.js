...
module.exports = React.createClass({
    ...
    getListSuccess (data) {
        if (data.success && data.context) {
            ...
            if (list) {
                const infiniteLoadStatus = (!list.length && this.pageNo === 1) ?
                    STATUS_NO_DATA :
                    (!list.length && this.pageNo === 1) ? STATUS_NO_DATA : list.length < this.pageCount ? STATUS_ALL_LOADED : STATUS_TEXT_HIDE;
