...
let Picker = Platform.OS==='android'?PickerAndroid:PickerIOS;
...
export default class PickerAny extends React.Component {
	...
	_getStateFromProps(props){
		...
		if (typeof(hideCancelBtn) == 'undefined') {
		   hideCancelBtn=false;
		}
		...
		return (
			<Animated.View style={[styles.picker, {
				...
				<View style={[styles.pickerBox, this.state.style]}>
					...
					<TouchableOpacity activeOpacity={0.6} style={styles.pickerFinishBtnOne} onPress={this._pickerFinish.bind(this)}>
						<Text style={[styles.pickerFinishBtnTextOne, this.state.pickerBtnStyle]}>
							{this.state.pickerBtnText}
						</Text>
					</TouchableOpacity>
					<TouchableOpacity activeOpacity={0.6} style={styles.pickerFinishBtnOne} onPress={this._pickerCancel.bind(this)}>
						<Text style={[styles.pickerFinishBtnTextOne, this.state.pickerBtnStyle]}>
