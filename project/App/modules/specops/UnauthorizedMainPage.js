...
module.exports = React.createClass({
    ...
    getSpecialSoldierDataSuccess (data) {
        if (data.success) {
            const { specialSoldierImgUrl, specialSoldierVedioName, specialSoldierVedioID, isWatchVideo, isDayActuallydoing, isDaySummary, isEverydayQuestion, introductionTitle, introductionContent } = data.context;
    ...
    render () {
        const { specialSoldierImgUrl, specialSoldierVedioName, isDayActuallydoing, isDaySummary, isEverydayQuestion, isWatchVideo, introductionTitle, introductionContent } = this.state;
