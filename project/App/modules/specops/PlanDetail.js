...
var {Button, InputBox, DatePicker} = COMPONENTS;
var sTimeFunc;
...
module.exports = React.createClass({
    ...
    statics: {
        ...
        rightButton: { image: app.img.common_calendar, handler: ()=>{
            app.showModal(<DatePicker onSetDate={sTimeFunc}/>);
        }},
    },
    goBack() {
        app.navigator.pop();
    ...
    daySummaryView() {
        ...
        let heightDaySummary = this.calculateStrLength(this.state.daySummary);
        return (
            <View style={styles.planViewStyle}>
                ...
                </View>
                {
                    problemArray.map((item, i)=>{
                        let heightProblemContent = this.calculateStrLength(item.problemContent);
                        return(
                            <View key={i}>
    ...
    //每周总结
    WeekSummaryView() {
        let heightWeekSummary = this.calculateStrLength(this.state.weekSummary);
        return (
            <View style={styles.planViewStyle}>
                <View style={styles.contextTextSummaryView}>
