...
var JoinSpecopsMessageBox = require('./JoinSpecopsMessageBox.js');
...
var CoursePlayer = React.createClass({
    ...
    render() {
        ...
        var {studyProgressDetail, isLookAll, taskNum, showVideoFinishBox, showPromptBox} = this.state;
        return (
