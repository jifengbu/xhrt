...
module.exports = React.createClass({
    ...
    render() {
        var speakerSource = this.props.speaker.userInfo.sex==0?app.img.train_girl:app.img.train_boy;
        var hearerList = _.reject(this.props.competitors, (item)=>this.props.speaker.userID==item.userID);
        return (
                    ...
                    <View style={styles.hearerIconContainer}>
                        {
                            hearerList.map((item, i)=>{
                                var source = item.userInfo.sex==0?app.img.train_girl_back:app.img.train_boy_back;
                                return (
                                    <Image
                                        key={i}
                                        resizeMode='stretch'
