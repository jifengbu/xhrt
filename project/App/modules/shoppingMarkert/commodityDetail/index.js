...
const AddPurchase = require('./AddPurchase.js');
const WriteOrder = require('../order/WriteOrder.js');
const IndexBottom = require('./indexBottom.js');
const ShopIntroduce = require('./ShopIntroduce.js');
const CommentBigImage = require('./CommentBigImage.js');
...
module.exports = React.createClass({
    ...
    gotoWriteOrderView (selectArray, totalPrice) {
        ...
        const selectStr = selectArray.join('-');
        app.navigator.push({
