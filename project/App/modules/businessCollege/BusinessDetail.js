...
module.exports = React.createClass({
    ...
    render () {
        let index = 1;
        let str = '<body><style>div{font-size: ' + (18 * PixelRatio.get() / PixelRatio.getFontScale()) + 'px}</style><div id="view">';
        ...
        let tempStr = str.replace(/<img/g, '<img width="100%" onload=imageLoad() onerror=imageLoad()');
