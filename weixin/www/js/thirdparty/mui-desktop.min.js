!function(){"use strict";function TouchList(){this.length=0}function Touch(){this.touchIdentifier=touchIdentifier++}var cancelClickMove=!1,userAgent=window.navigator.userAgent,tmp;try{return void(tmp=document.createEvent("TouchEvent"))}catch(ex){}window.ontouchstart=function(){};var preventAll=function(e){e.preventDefault(),e.stopPropagation()},ieThreshold=userAgent.match(/Phone/i)?2:7,preventAllButInputs=function(e,t){if(t.tagName){var n=t.tagName.toUpperCase();n.indexOf("SELECT")>-1||n.indexOf("TEXTAREA")>-1||n.indexOf("INPUT")>-1||n.indexOf("DIV")>-1&&t.contentEditable||preventAll(e)}};TouchList.prototype={item:function(e){return this[e]},_add:function(e){this[this.length]=e,this.length++}};var touchIdentifier=1e3;Touch.prototye={clientX:0,clientY:0,screenX:0,screenY:0,pageX:0,pageY:0,identifier:0};var redirectMouseToTouch=function(type,originalEvent,newTarget,skipPrevent){var theTarget=newTarget?newTarget:originalEvent.target;skipPrevent||preventAllButInputs(originalEvent,theTarget);var touchevt=document.createEvent("MouseEvent");touchevt.initEvent(type,!0,!0),touchevt.initMouseEvent(type,!0,!0,window,originalEvent.detail,originalEvent.screenX,originalEvent.screenY,originalEvent.clientX,originalEvent.clientY,originalEvent.ctrlKey,originalEvent.shiftKey,originalEvent.altKey,originalEvent.metaKey,originalEvent.button,originalEvent.relatedTarget),touchevt.touches=new TouchList,touchevt.changedTouches=new TouchList,touchevt.targetTouches=new TouchList;var thetouch=new Touch;if(thetouch.pageX=originalEvent.pageX,thetouch.pageY=originalEvent.pageY,thetouch.target=originalEvent.target,touchevt.changedTouches._add(thetouch),"touchend"!==type&&(touchevt.touches=touchevt.changedTouches,touchevt.targetTouches=touchevt.changedTouches),touchevt.mouseToTouch=!0,userAgent.match(/MSIE 10.0/i)||userAgent.match(/Trident\/7/i)?!0:!1)for(var elem=originalEvent.target;null!==elem;)elem.hasAttribute("on"+type)&&eval(elem.getAttribute("on"+type)),elem=elem.parentElement;theTarget.dispatchEvent(touchevt)},mouseDown=!1,lastTarget=null,prevX=0,prevY=0;if(window.navigator.msPointerEnabled){var skipMove=!1;document.addEventListener("MSPointerDown",function(e){mouseDown=!0,skipMove=!0,lastTarget=e.target,"a"===e.target.nodeName.toLowerCase()&&"javascript:;"===e.target.href.toLowerCase()&&(e.target.href=""),redirectMouseToTouch("touchstart",e,null,!0),cancelClickMove=!1,prevX=e.clientX,prevY=e.clientY},!0),document.addEventListener("MSPointerUp",function(e){mouseDown&&(redirectMouseToTouch("touchend",e,lastTarget,!0),lastTarget=null,mouseDown=!1)},!0),document.addEventListener("MSPointerMove",function(e){Math.abs(e.clientX-prevX)<=ieThreshold||Math.abs(e.clientY-prevY)<=ieThreshold||mouseDown&&(redirectMouseToTouch("touchmove",e,lastTarget,!0),cancelClickMove=!0)},!0)}else document.addEventListener("mousedown",function(e){mouseDown=!0,lastTarget=e.target,"a"===e.target.nodeName.toLowerCase()&&"javascript:;"===e.target.href.toLowerCase()&&(e.target.href="#"),redirectMouseToTouch("touchstart",e),cancelClickMove=!1,prevX=e.clientX,prevY=e.clientY},!0),document.addEventListener("mouseup",function(e){mouseDown&&(redirectMouseToTouch("touchend",e,lastTarget),lastTarget=null,mouseDown=!1)},!0),document.addEventListener("mousemove",function(e){(e.clientX!==prevX||e.clientY!==prevY)&&mouseDown&&(redirectMouseToTouch("touchmove",e,lastTarget),cancelClickMove=!0)},!0);document.addEventListener("drag",preventAll,!0),document.addEventListener("dragstart",preventAll,!0),document.addEventListener("dragenter",preventAll,!0),document.addEventListener("dragover",preventAll,!0),document.addEventListener("dragleave",preventAll,!0),document.addEventListener("dragend",preventAll,!0),document.addEventListener("drop",preventAll,!0),document.addEventListener("selectstart",function(e){preventAllButInputs(e,e.target)},!0),document.addEventListener("click",function(e){e.mouseToTouch||e.target!==lastTarget||preventAll(e),cancelClickMove&&(preventAll(e),cancelClickMove=!1)},!0)}();
